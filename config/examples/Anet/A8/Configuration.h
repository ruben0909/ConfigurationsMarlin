...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define DEFAULT_Kp 44.23
  #define DEFAULT_Ki 5.87
  #define DEFAULT_Kd 83.33
...
//#define PID_BED_DEBUG // Sends debug data to the serial port.
  ...
  #define DEFAULT_bedKp 123.99
  #define DEFAULT_bedKi 16.45
  #define DEFAULT_bedKd 622.95
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 427.03 }
 ...
 */
//#define NO_LCD_MENUS //OJO si quitas los menus se ahorra un 20%
